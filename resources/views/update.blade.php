        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{URL::to('/update')}}">
                        ...
                        <div class="form-group{{ $errors->has('fname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="fname" value="{{ Auth::user()->first_name}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('sname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="sname" value="{{ Auth::user()->surname}}" required autofocus>
